...
class DataStore {
  ...
  private loadFromStorage(): DataState {
    ...
    return {
      ...
      grades: [
        { id: 1, studentId: 1, studentName: 'John Doe', class: '9A', subject: 'Mathematics', weeklyTest: 18, project: 23, assignment: 17, takeHomeTest: 14, endOfTermTest: 19, totalMarks: 91, letterGrade: 'D', term: 'Term 1' },
        { id: 2, studentId: 2, studentName: 'Jane Smith', class: '9A', subject: 'English', weeklyTest: 15, project: 20, assignment: 14, takeHomeTest: 13, endOfTermTest: 16, totalMarks: 78, letterGrade: 'C', term: 'Term 1' },
        { id: 3, studentId: 3, studentName: 'Michael Johnson', class: '9B', subject: 'Mathematics', weeklyTest: 10, project: 15, assignment: 11, takeHomeTest: 12, endOfTermTest: 10, totalMarks: 58, letterGrade: 'UP', term: 'Term 1' },
